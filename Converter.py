...
def Convert():
    ...
    kilogramsentry.delete('1.0', END)
    kilogramsentry.insert(END, kilogramstext)
    poundsentry.delete('1.0', END)
    poundsentry.insert(END, poundstext)
    ouncesentry.delete('1.0', END)
    ouncesentry.insert(END, ouncestext)
...
kilogramsentry = tkinter.Text(screen, width=30)
